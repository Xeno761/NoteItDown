...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeMaterial3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>composeM3</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxComposeMaterial3AdaptiveLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>composeAdaptive</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class ColorpickerLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>colorpickerCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class CommonmarkLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final CommonmarkExtLibraryAccessors laccForCommonmarkExtLibraryAccessors = new CommonmarkExtLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>commonmark.ext</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CommonmarkExtLibraryAccessors getExt() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCommonmarkExtLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class CommonmarkExtLibraryAccessors extends SubDependencyFactory {
        private final CommonmarkExtGfmLibraryAccessors laccForCommonmarkExtGfmLibraryAccessors = new CommonmarkExtGfmLibraryAccessors(owner);
        private final CommonmarkExtHeadingLibraryAccessors laccForCommonmarkExtHeadingLibraryAccessors = new CommonmarkExtHeadingLibraryAccessors(owner);
        private final CommonmarkExtImageLibraryAccessors laccForCommonmarkExtImageLibraryAccessors = new CommonmarkExtImageLibraryAccessors(owner);
        private final CommonmarkExtTaskLibraryAccessors laccForCommonmarkExtTaskLibraryAccessors = new CommonmarkExtTaskLibraryAccessors(owner);

        public CommonmarkExtLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>commonmark.ext.gfm</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CommonmarkExtGfmLibraryAccessors getGfm() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCommonmarkExtGfmLibraryAccessors;
        }

        /**
         * Group of libraries at <b>commonmark.ext.heading</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CommonmarkExtHeadingLibraryAccessors getHeading() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCommonmarkExtHeadingLibraryAccessors;
        }

        /**
         * Group of libraries at <b>commonmark.ext.image</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CommonmarkExtImageLibraryAccessors getImage() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCommonmarkExtImageLibraryAccessors;
        }

        /**
         * Group of libraries at <b>commonmark.ext.task</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CommonmarkExtTaskLibraryAccessors getTask() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCommonmarkExtTaskLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class CommonmarkExtGfmLibraryAccessors extends SubDependencyFactory {

        public CommonmarkExtGfmLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>strikethrough</b> with <b>org.commonmark:commonmark-ext-gfm-strikethrough</b> coordinates and
         * with version reference <b>commonmark</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getStrikethrough() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("commonmark.ext.gfm.strikethrough");
        }

        /**
         * Dependency provider for <b>tables</b> with <b>org.commonmark:commonmark-ext-gfm-tables</b> coordinates and
         * with version reference <b>commonmark</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getTables() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("commonmark.ext.gfm.tables");
        }
     ...
     */
    @Deprecated
    public static class CommonmarkExtHeadingLibraryAccessors extends SubDependencyFactory {

        public CommonmarkExtHeadingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>anchor</b> with <b>org.commonmark:commonmark-ext-heading-anchor</b> coordinates and
         * with version reference <b>commonmark</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getAnchor() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("commonmark.ext.heading.anchor");
        }
     ...
     */
    @Deprecated
    public static class CommonmarkExtImageLibraryAccessors extends SubDependencyFactory {

        public CommonmarkExtImageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>attributes</b> with <b>org.commonmark:commonmark-ext-image-attributes</b> coordinates and
         * with version reference <b>commonmark</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getAttributes() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("commonmark.ext.image.attributes");
        }
     ...
     */
    @Deprecated
    public static class CommonmarkExtTaskLibraryAccessors extends SubDependencyFactory {
        private final CommonmarkExtTaskListLibraryAccessors laccForCommonmarkExtTaskListLibraryAccessors = new CommonmarkExtTaskListLibraryAccessors(owner);

        public CommonmarkExtTaskLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>commonmark.ext.task.list</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CommonmarkExtTaskListLibraryAccessors getList() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCommonmarkExtTaskListLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class CommonmarkExtTaskListLibraryAccessors extends SubDependencyFactory {

        public CommonmarkExtTaskListLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>items</b> with <b>org.commonmark:commonmark-ext-task-list-items</b> coordinates and
         * with version reference <b>commonmark</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getItems() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("commonmark.ext.task.list.items");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>colorpickerCompose</b> with value <b>1.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>commonmark</b> with value <b>0.22.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeAdaptive</b> with value <b>1.0.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeAdaptive() { return getVersion("composeAdaptive"); }
        ...
        /**
         * Version alias <b>composeFoundation</b> with value <b>1.7.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeM3</b> with value <b>1.3.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeM3() { return getVersion("composeM3"); }
        ...
        /**
         * Version alias <b>lifecycleRuntimeCompose</b> with value <b>2.8.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>googleHilt</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>hilt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getGoogleHilt() { return createPlugin("googleHilt"); }
