package com.xeno761.noteitdown.presentation.util

object Constants {
    const val DEFAULT_MAX_LINES = 2
    const val NAV_ANIMATION_TIME = 300
    const val MIME_TYPE_TEXT = "text/"
    const val LINK = "myapp://navigate"
    object File {
        const val NOTEITDOWN = "Noteitdown"
        const val NOTEITDOWN_BACKUP = "Noteitdown/Backup"
    }
